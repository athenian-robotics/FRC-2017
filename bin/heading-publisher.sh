...
python3 ~pi/git/FRC-2017/heading_publisher.py --mqtt mqtt-turtle.local --mpt 1 --calib --cpt 2 --did 00FEBABC --baud 115200 &> ~pi/git/FRC-2017/logs/heading_publisher.out &
